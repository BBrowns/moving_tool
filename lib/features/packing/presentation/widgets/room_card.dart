...
import 'package:moving_tool_flutter/features/packing/presentation/extensions/room_display_extension.dart';

class RoomCard extends StatelessWidget {

  const RoomCard({
    required this.room, required this.boxes, required this.items, required this.onAddBox, required this.onDeleteRoom, required this.onTap, super.key,
  });
  final Room room;
