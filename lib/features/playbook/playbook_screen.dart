  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton:
          (_tabController.index == 0 && journal.isEmpty) ||
          ...
          : FloatingActionButton.extended(
              ...
              icon: Icon(
                _tabController.index == 0 ? Icons.edit_note : Icons.add,
              ),
                    ...
                    onPressed: value.text.isNotEmpty
                        ? () {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text('Logboek item toegevoegd'),
                              ),
                            );
                          }
                        : null,
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'Activiteiten worden hier automatisch bijgehouden',
